...
public class MTP_ORDER_steps 
{
	...
	public MTP_ORDER_steps() throws FileNotFoundException, IOException
	{
		logger=LoggerGen.logGen(MTP_ORDER_steps.class.getName());
		
	}
	@Given("^Env\"([^\"]*)\" is UP for MPT order Creation for$")
	public void env_is_UP_for_MPT_order_Creation_for(String eNv) throws Exception 
	{
		logger.info("=============================================MTP Order Creation Started=============================================");
		logger.info(eNv+" is up");
		envName=eNv;
            envName=System.getProperty("enviroment");
	}

	@When("^First CNOD of UNI_A is pushed to OCX for MPT\"([^\"]*)\" \"([^\"]*)\"$")
	public void first_CNOD_of_UNI_A_is_pushed_to_OCX_for_MPT(String eNv, String stateRegion) throws Throwable 
	{
	...
	@When("^Second CNOD of UNI_B is pushed to OCX for MPT\"([^\"]*)\" \"([^\"]*)\"$")
	public void second_CNOD_of_UNI_B_is_pushed_to_OCX_for_MPT(String eNv, String stateRegion) throws Throwable 
	{
	...
	@When("^third CNOD of UNI_C is pushed to OCX for MPT\"([^\"]*)\" \"([^\"]*)\"$")
	public void third_CNOD_of_UNI_C_is_pushed_to_OCX_for_MPT(String eNv, String stateRegion) throws Throwable
	{
	     logger.info("==========UNI Order creation started===========");
		 logger.info("===========eNv==========");
		 TriggerCNODRequest tr1 = new TriggerCNODRequest();
