...
public class SAREA_disconnect_cancel_steps {
	...
	public SAREA_disconnect_cancel_steps() throws FileNotFoundException, IOException
	{
		logger=LoggerGen.logGen(SAREA_disconnect_cancel_steps.class.getName());
		
	}
	
	@Given("^Env is up for SAREA_DISCONNECT_CANCEL order creation for \"([^\"]*)\"$")
	public void env_is_up_for_SAREA_DISCONNECT_CANCEL_order_creation_for(String Env) throws Exception 
	{
		envName=Env;
	...
	@When("^CNOD of SAREA is pushed to OCX for SAREA_DISCONNECT_CANCEL\"([^\"]*)\"$")
	public void cnod_of_SAREA_is_pushed_to_OCX_for_SAREA_DISCONNECT_CANCEL(String Env) throws Throwable 
	{
	...
	@When("^Push notify on request for SAREA_DISCONNECT_CANCEL\"([^\"]*)\"$")
	public void push_notify_on_request_for_SAREA_DISCONNECT_CANCEL(String Env) throws Exception 
	{
	...
	@When("^Push Disconnect request for SAREA_DISCONNECT_CANCEL\"([^\"]*)\"$")
	public void push_Disconnect_request_for_SAREA_DISCONNECT_CANCEL(String Env) throws Exception 
	{
		...
		orderId1=productNames.get("productOrderItemId").get(0);
		Thread.sleep(20000);
	...
	@Then("^Push cancel request for SAREA_DISCONNECT_CANCEL(.*)$")
	public void push_cancel_request_for_SAREA_DISCONNECT_CANCEL(String eNv) throws Throwable 
	{
		logger.info("==========UNI disc Cancel Order creation started===========");
		rsponse2 =TriggerCNODRequest.triggerUNI_Cancel(envName, orderId1);
		oaIds2= OCXOrderCreation_GAMMA.getElementFromXml(rsponse2,"productOrderItemId");
		logger.info("==========UNI disc Cancel Order created===========");
	}
	

	@Then("^SAREA_DISCONNECT_CANCEL  is created in OCX\\.$")
	public void sarea_disconnect_cancel_is_created_in_OCX() throws Exception 
	{
		logger.info("==========UNI disc Cancel Order created==========="); 
	}
}
